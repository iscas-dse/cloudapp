...
<!-- text fonts -->
<link rel="stylesheet"
	href="<c:url value='/css/fonts/fonts.googleapis.com.css' />" />
...
<!--[if lte IE 9]>
    <link rel="stylesheet" href="<c:url value='/css/ace/ace-ie.min.css' />" />
    <![endif]-->
...
<script src="<c:url value='/js/ipipeline/login/html5shiv.min.js' />"></script>
<script src="<c:url value='/js/ipipeline/login/respond.min.js' />"></script>
<script src="<c:url value='/js/ipipeline/app/login.js' />"></script>
			...
			<div class="row">
				<div class="col-sm-10 col-sm-offset-1">
					<div class="login-container">
						<div class="center">
							<h1>
								<i class="ace-icon fa fa-leaf green"></i> <span class="red">IntelliPipeline</span>
								<span class="white" id="id-text2"></span>
							</h1>
							<h4 class="blue" id="id-company-text">&copy; ISCAS</h4>
						</div>
